...
// resourcesPathFor builds the podtemplate/resources path for a workspace.
...
// doResourcesRequest invokes the handler for the given namespace/workspace as the given user.
func doResourcesRequest(namespace, workspace, userID string) *http.Response {
