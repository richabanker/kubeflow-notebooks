...
// ErrWorkspaceNotFound is returned when a Workspace does not exist. It is raised by both the
// workspaces and metrics repositories, and handlers map it to a 404.
